...
export default{
    setup() {
        ...
        function handleEdit(id: number) {
            ...
            if (taskToEdit) {
                const updateTask = document.getElementById('update-Task') as HTMLInputElement;
                ...
                updateBtn.onclick = async () => {
                    ...
                    if (updatedTask !== ''){
                        try {
                            ...
                            const index = BackendTasks.value.findIndex(task => task.id === id);
                            if (index !== -1) {
        ...
        function handleAddTask() {
            ...
            addBtn.onclick = async (event: Event) => {
                ...
                const newTask = await addTask(addForm.value);
                BackendTasks.value.push(newTask);

                console.log("New task added:", newTask);
                alert("Task added successfully!");

                addForm.value = ''; // Clear the input field after adding the task
    ...
    <div class="general-forms">    
        <section id="add-todo">
            ...
            <form id="add-todo-form">
                ...
                <textarea id="addForm" name="todo" type="text" placeholder="Enter Task" rows="4" cols="40" required></textarea>
        ...
        <section id = "update-todo">
            ...
            <form id="update-todo-form">
                ...
                <textarea id="update-Task" name="task" type="text" placeholder="Enter Task" rows="4" cols="40" required></textarea>
